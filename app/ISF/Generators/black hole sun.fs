/*
 {
  "DESCRIPTION": "Radial distortion with swirling noise patterns and a central bright spot.",
  "CREDIT": "by Andrea Bovo <https://linktr.ee/spleenooname>, based on 'Flaring' by nimitz (shadertoy.com/view/lsSGzy)",
  "CATEGORIES": [
    "Complex",
    "Animated",
    "Efficient",
