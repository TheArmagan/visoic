/*{
    ...
    "CREDIT": "By mojovideotech, based on shadertoy.com/lslcWj by LukeRissacher.",
    "DESCRIPTION": "A glowing, pulsating sphere with fluid deformations and embedded luminescent nodes.",
    "INPUTS": [
        {
            "DEFAULT": [
                0.5,
