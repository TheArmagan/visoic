/*
{
  ...
  "CREDIT": "By Silvia Fabiani, based on shadertoy.com/view/4dS3WDATE by Morgan McGuire, modified by @patriciogv.",
  "DESCRIPTION": "Flowing, turbulent noise with layered color blending and dynamic contrast.",
  "ISFVSN" : "2",
  "INPUTS" : [
  {
      "NAME" : "Scaling",
