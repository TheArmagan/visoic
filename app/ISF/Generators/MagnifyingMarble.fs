/*{
	"CREDIT": "By mojovideotech, based on shadertoy.com/view/ldfSDN.",
  "DESCRIPTION": "Magnifying spherical lens distorting animated Perlin noise with Fresnel lighting and refraction.",
  "CATEGORIES": [
    "Animated",
    "Complex",
    "Efficient",
