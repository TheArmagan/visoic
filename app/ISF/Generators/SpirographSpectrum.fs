/*{
  "CREDIT": "By mojovideotech, based on shadertoy.com/view/lddGD4 by Xor.",
  "DESCRIPTION": "Radial spirograph pattern with smooth spectral color gradients and fine circular symmetry.",
  "CATEGORIES": [
    "Animated",
    "Complex",
    "Efficient",
