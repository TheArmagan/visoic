/*{
	"CREDIT": "by mojovideotech, automatically converted from https://www.shadertoy.com/view/4tfSzn by FabriceNeyret2",
  "CATEGORIES": [
    "Complex", "Inefficient", "Animated", "NonCommercial"
  ],
  "DESCRIPTION": "Undulating multicolored ribbons with organic, fluid motion on a black background.",
  "IMPORTED": [
