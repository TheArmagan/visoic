/*{
	"CREDIT": "By mojovideotech, based on glslsandbox.com/e#44948.0 and interactiveshaderformat.com/sketches/2358.",
	"DESCRIPTION": "Radial particle streaks expanding outward with layered vortex distortions and animated motion.",
	"CATEGORIES": [
		"Animated",
		"Complex",
		"Efficient",
