/*{
  "CREDIT": "By mojovideotech, based on shadertoy.com/view/XlX3Rj by Kali.",  
"DESCRIPTION": "Intricate fractal circuits with recursive patterns, glowing nodes, and a dynamic kaleidoscopic structure.",  
  "CATEGORIES": [
  	"Animated",
  	"Complex",
    "Fractal",
