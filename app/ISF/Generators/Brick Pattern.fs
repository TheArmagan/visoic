...
{
  "CATEGORIES" : [
    "Basic", "Static", "Efficient", "Commercial"
  ],
  "DESCRIPTION": "Tiled brick pattern with adjustable size, offset, and color.",  
  "CREDIT": "Based on Brick example from https://thebookofshaders.com/09/ by @patriciogv (patriciogonzalezvivo.com) - 2015.",
  "ISFVSN" : "2",
  "INPUTS" : [
    {
      "NAME" : "brickSize",
