/*{
	"CREDIT": "by mojovideotech, based on https://glslsandbox.com/e#41853.0.",
	"DESCRIPTION": "Spherical fractal pattern with iterative deformations, rotation, and complex color mapping.",
  "CATEGORIES" : [
    "Fractal",
    "Complex",
		"Animated",
