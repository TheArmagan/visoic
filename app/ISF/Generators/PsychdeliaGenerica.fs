/*{
	"CREDIT": "By mojovideotech, based on glslsandbox.com/e#25956.0",  
	"DESCRIPTION": "Psychedelic concentric color bands with smooth gradients and rotational distortion.",  
  "CATEGORIES": [
    "Animated",
		"Complex",
		"Efficient",
...
// PsychedeliaGenerica by mojovideotech
// copied from :
// http://glslsandbox.com/e#25956.0
