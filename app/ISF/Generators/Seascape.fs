/*
{
  ...
  "CREDIT": "By Alexander Alekseev aka TDM, based on shadertoy.com/view/Ms2SD1.",
    "DESCRIPTION": "Realistic ocean waves with dynamic reflections, foam, and light scattering.",
  "IMPORTED": [
