/*{
	"CREDIT": "By mojovideotech, based on glslsandbox.com/e#29962.1 by @301z.",
	"DESCRIPTION": "Billowing liquid-like fire simulation with shifting density and color gradients.",
	"CATEGORIES": [
		"Animated",
		"Complex",
		"Efficient",
