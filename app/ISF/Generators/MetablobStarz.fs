/*{
	"CREDIT": "By mojovideotech, based on shadertoy.com/view/4sXXWM by pailhead, modified by I.G.P.",
	"DESCRIPTION": "Dynamic metaball grid with vibrant refractions, blending, and fluid-like deformations.",
  "CATEGORIES" : [
    "Animated",
		"Complex",
		"Efficient",
