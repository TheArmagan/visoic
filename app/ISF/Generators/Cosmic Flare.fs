/*{
	"DESCRIPTION": "A swirling cosmic flare with adjustable color, brightness, and curvature.",
	"CREDIT": "by mojovideotech, based on 'Flaring' by nimitz, https://www.shadertoy.com/view/lsSGzy",
	"CATEGORIES": [
		"Animated", "Complex", "Efficient", "Space", "NonCommercial", "Radial"
	],
	"INPUTS": [
	 {
            "NAME": "brightness",
