/*{
	"CREDIT": "By mojovideotech, based on glslsandbox.com/e#38710.0 by Trisomie21, modified by @hintz.",
	"DESCRIPTION": "Colorful, warped concentric patterns with adjustable scale, loops, and hue variations.",
	"CATEGORIES" : [
    "Complex",
    "Animated",
		"Efficient",
