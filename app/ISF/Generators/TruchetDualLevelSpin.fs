/*{
  "CREDIT": "By mojovideotech, based on shadertoy.com/view/ltcfz2 by Shane.",
    "DESCRIPTION": "Interwoven truchet-like curves with layered circular elements and gradient shading.",
  "CATEGORIES" : [
    "Animated",
    "Complex",
    "Efficient",
