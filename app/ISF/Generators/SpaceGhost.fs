/*{
  "CREDIT": "By mojovideotech, based on glslsandbox.com/e#31191.1 by Robert, modified from shadertoy.com/view/MtX3Ws.",  
  "DESCRIPTION": "Glowing fractal structures with deep-space aesthetics and dynamic morphing patterns.",  
  "CATEGORIES": [
    "Animated",
    "Complex",
    "Efficient",
