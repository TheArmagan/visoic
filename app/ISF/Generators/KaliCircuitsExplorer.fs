/*{
  "DESCRIPTION": "Fractal-based circuit-like patterns with intricate glowing details and recursive symmetry.",
  "CREDIT": "by mojovideotech, based on shadertoy.com/XlX3Rj by Kali",
  "CATEGORIES": [
    "Fractal",
    "Animated",
    "Complex",
