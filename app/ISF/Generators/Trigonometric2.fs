/*{
  ...
  "CREDIT": "By mojovideotech, based on shadertoy.com/view/Mdl3RH by IQ - www.iquilezles.org, modified by @hintz.",
  "DESCRIPTION": "Flowing, organic trigonometric distortions with intricate, high-contrast wave patterns.",
  "INPUTS": [
    {
      "MAX": [
        10,
