/*{
	"CREDIT": "By mojovideotech, based on shadertoy.com/MdSGRc and glslsandbox.com/e#47085.0.",  
    "DESCRIPTION": "Abstract 3D-like Voronoi cubes arranged in an isometric pattern with soft lighting and smooth color gradients.",  
"CATEGORIES" : [
    "Animated",
    "Complex",
    "Efficient",
...
void main( void ) 
{
    ...
    vec3 col = 0.5 + 0.95 * sin(c.y * Sat + vec3(C, M, Y));
    col *= sqrt(clamp(1.0 - c.x, 0.0, 1.0));
	col *= clamp(0.5 + (1.0 - c.z / 2.0) * 0.2, 0.0, 1.0);
