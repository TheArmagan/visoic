...
/*{
  "CREDIT": "By Joseph Fiola, based on shadertoy.com/view/4dsGzH by bonniem.",
  "DESCRIPTION": "Radiating sine wave filaments converging at a central point with adjustable density and curvature.",
  "CATEGORIES": [
    "Static",
    "Efficient",
    "Basic",
