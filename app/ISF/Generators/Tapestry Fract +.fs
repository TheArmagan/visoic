/*{
	"CREDIT": "By echophons, based on glslsandbox.com/e#18752.0 with modifications by Doctor Mojo.",
	"DESCRIPTION": "Recursive fractal patterns with dynamic reflections and glowing geometric distortions.",
	"CATEGORIES": [ 
		"Animated",
		"Complex",
		"Efficient",
