/*{
	"CREDIT": "By Nicolas Robert, based on glslsandbox.com/e#15588.0 and concept from iquilezles.org.",  
	"DESCRIPTION": "Layered Voronoi cell structures with animated distortions and shifting organic outlines.",  
  "CATEGORIES" : [
    "Animated",
		"Inefficient",
		"Complex",
