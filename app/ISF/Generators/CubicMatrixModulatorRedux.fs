/*{
  "CREDIT": "By mojovideotech, based on shadertoy.com/XsB3Rm, modified by @hintz.",
  "DESCRIPTION": "Intricate, geometric matrix of intersecting cubic forms with dynamic distortions and color modulation.",
  "CATEGORIES": [
  	"Complex",
    "Animated",
    "Inefficient",
