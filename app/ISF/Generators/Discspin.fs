...
/*{
  "DESCRIPTION": "Radial spinning pattern composed of concentric curved lines with alternating thickness and mirrored symmetry.",
  "CREDIT": "by Joseph Fiola \\(http://www.joefiola.com\\), based on 'The Power of Sin' by antonOTI \\(https://www.shadertoy.com/view/XdlSzB\\)",
  "CATEGORIES": [
    "Complex",
    "Animated",
    "Efficient",
