/*{
	"DESCRIPTION": "A recursive fractal pattern with rotational symmetry and evolving depth.",
	"CREDIT": "by mojovideotech, based on https://www.shadertoy.com/view/XlXcWj",
	"CATEGORIES": [
		"Fractal",
		"Complex",
		"Animated",
