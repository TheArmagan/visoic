/*{
  ...
  "CREDIT": "By mojovideotech, based on shadertoy.com/view/ltBXRc by phil",  
  "DESCRIPTION": "Glowing, pulsating ring with smooth distortions and animated color shifts.",  
  "INPUTS" : [
    {
      "NAME" :      "center",
      "TYPE" :      "point2D",
