/*{
	"CREDIT": "By mojovideotech, based on shadertoy.com/view/MsXGR2 by rez.",  
	"DESCRIPTION": "Dark, mechanical structures with glowing elements, deep shadows, and a sense of depth through raymarching.",  
  "CATEGORIES": [
    "Raymarching",
    "Animated",
		"Inefficient",
