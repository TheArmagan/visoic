/*{
	"CREDIT": "By mojovideotech, based on glslsandbox.com/e#42684.2 by @hintz.",
	"DESCRIPTION": "Vibrant, twisting colored bars with adjustable scale, rotation, and looping effects.",
 	"CATEGORIES" : [
	 "Animated",
	 "Efficient",
	 "Complex",
