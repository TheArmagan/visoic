/*{
	"CREDIT": "By FabriceNeyret2, based on glslsandbox.com/e#38710.0 by Trisomie21, optimized by Dave_Hoskins.",
	"DESCRIPTION": "Vivid blue spiral galaxy with dynamic core brightness and scattered star-like structures.",
	"CATEGORIES": [
		"Animated",
		"Complex",
		"Inefficient",
