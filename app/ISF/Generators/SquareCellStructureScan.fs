/*{
	"CREDIT": "By mojovideotech, based on glslsandbox.com/e#21290.5.",
	"DESCRIPTION": "Recursive circuit-like grid structure with glowing blue highlights and intricate rectangular subdivisions.",
  "CATEGORIES": [
    "Animated",
		"Efficient",
		"Complex",
