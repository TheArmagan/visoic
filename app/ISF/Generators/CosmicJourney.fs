/*{
  "CATEGORIES": [
    "Animated", "Complex", "Space", "Inefficient", "NonCommercial"
  ],
  "DESCRIPTION": "A fractal-based nebula with evolving patterns and embedded star-like details.",
	"CREDIT": "by mojovideotech, based on https://www.shadertoy.com/view/lslGWr and http://glslsandbox.com/e#6904.0",
  "INPUTS": [
