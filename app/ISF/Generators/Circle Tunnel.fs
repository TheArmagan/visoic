/*
{
  ...
  "DESCRIPTION": "3D tunnel composed of concentric rings with alternating colors and adjustable movement.",
  "CREDIT": "Flyguy, automatically converted from https://www.shadertoy.com/view/Xlt3R8",
  "INPUTS" : [
    {
      "NAME" : "CIRCLE_SIZE",
      "TYPE" : "float",
