/*{
	"CREDIT": "By You, featuring fractal noise with structured striping and color variation.",
	"DESCRIPTION": "Layered Perlin-based marbling with geometric striping and adjustable pattern distortion.",
	"CATEGORIES": [
		"Complex",
		"Static",
		"Inefficient",
