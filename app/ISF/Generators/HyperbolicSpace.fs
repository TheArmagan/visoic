/*{
  ...
  "CREDIT": "By mojovideotech, based on glslsandbox.com/e#1479.2 by Kabuto.",
	"DESCRIPTION": "Hyperbolic maze-like structures with recursive geometric patterns and smooth gradients.",
  "INPUTS": [
    {
      "MAX": [
        1,
