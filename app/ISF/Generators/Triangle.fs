/*{
    ...
    "CREDIT": "By Carter Rosenberg, based on glslsandbox.com/e#38710.0 by Trisomie21, modified by @hintz.",
    "DESCRIPTION": "Flat-shaded adjustable triangle with customizable position and colors.",
    "INPUTS": [
        {
            "DEFAULT": [
                0,
