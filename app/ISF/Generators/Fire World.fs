/*
{
	"CREDIT": "By kruhft, based on glslsandbox.com/e#34710.2, originally by Duke on shadertoy.com/view/lsySzd.",
	"DESCRIPTION": "Fiery volumetric explosion with swirling motion and bright glowing patterns.",
  "CATEGORIES" : [
    "Animated",
		"Complex",
		"Inefficient",
