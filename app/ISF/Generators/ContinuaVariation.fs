/*{
	"DESCRIPTION": "Flowing neon-like tendrils forming a continuous wave structure with intricate swirling distortions.",
	"CREDIT": "by mojovideotech, based on glslsandbox.com/e#32770.3",
  "CATEGORIES" : [
    "Complex",
		"Animated",
		"Efficient",
