/*{
	"DESCRIPTION": "Radial burst of high-contrast rays emanating from a central point with dynamic color shifts.",
	"CREDIT": "by mojovideotech, based on shadertoy.com/ldjcWy by Hadyn Lander and shadertoy.com/XsX3zB by Nikita Miropolskiy",
	"CATEGORIES": [
		"Animated",
		"Complex",
		"Efficient",
