/*{
 "DESCRIPTION": "Equirectangular wave interference pattern with spiraling distortions and rotational modulation.",
  "CREDIT": "by mojovideotech, mod of shadertoy.com/4dyfW1 by iridule",
 "CATEGORIES" : [
    "Complex",
    "Animated",
    "Efficient",
