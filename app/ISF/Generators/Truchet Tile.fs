/*{
    ...
    "CREDIT": "By pjkarlik, based on github.com/pjkarlik/TruchetTiles, modified by @hintz.",
    "DESCRIPTION": "Black and white Truchet tile pattern with randomized geometric variations.",
    "INPUTS": [
        {
            "DEFAULT": 0.1,
            "LABEL": "Size",
