/*{
	"CREDIT": "By mojovideotech, based on glslsandbox.com/e#25631.3.",
    "DESCRIPTION": "Fractal-based molecular fluid with dynamic color blending and recursive distortions.",
	"CATEGORIES": [
        "Animated",
        "Complex",
        "Inefficient",
