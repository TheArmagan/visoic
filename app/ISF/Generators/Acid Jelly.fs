/*{
    "CATEGORIES": [
        "Fractal", "Complex", "Animated", "Efficient", "NonCommercial"
    ],
    "CREDIT": "https://www.shadertoy.com/user/yozic, based on https://www.shadertoy.com/view/WtGfRw.",
    "DESCRIPTION": "Dynamic vortex pattern with swirling colors and recursive distortions.",
    "INPUTS": [
        {
            "DEFAULT": 0.07,
            "NAME": "zoom",
