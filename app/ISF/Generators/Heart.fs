/*{
	"CREDIT": "By VIDVOX, adapted from glsl.io/transition/d71472a550601b96d69d.",
	"DESCRIPTION": "Simple heart shape with adjustable size and fill color.",
	"ISFVSN": "2",
	"CATEGORIES": [
		"Static", "Basic", "Efficient", "Commercial"
	],
	"INPUTS": [
		{
			"NAME": "size",
