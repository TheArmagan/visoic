/*{
    "CREDIT": "By mojovideotech, based on shadertoy.com/view/MtjGz3 by curena.",
    "DESCRIPTION": "Hyperbolic circle inversion with p6mm wallpaper symmetry and dynamic tiling.",
  "CATEGORIES" : [
    "Animated",
    "Complex",
    "Efficient",
