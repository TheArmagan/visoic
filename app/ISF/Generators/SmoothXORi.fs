/*{
  ...
  "CREDIT": "By mojovideotech, based on shadertoy.com/view/Ml2GWy by iq.",
  "DESCRIPTION": "Recursive XOR-based tiling with smooth blending and layered intensity modulation.",
  "IMPORTED": [
