/*{
	"CREDIT": "By mojovideotech, based on glslsandbox.com/e#42620.1 and shadertoy.com/llXcRl, modified by @hintz.",
	"DESCRIPTION": "Fractal mandala patterns with kaleidoscopic symmetry, adjustable sides, loops, and dynamic color inversion.",
	"CATEGORIES": [
		"Complex",
		"Animated",
		"Efficient",
