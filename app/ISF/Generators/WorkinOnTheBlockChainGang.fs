/*{
  "DESCRIPTION": "Stacked horizontal bars forming oscillating waveform-like structures with randomized colors.",
  "CREDIT": "by mojovideotech, based on glslsandbox.com/e#30939.0",
  "CATEGORIES": [
