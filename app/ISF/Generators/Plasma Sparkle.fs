/*
{
   "CREDIT": "By unknown, based on a plasma and noise shader with dynamic motion and symmetrical warping.",
   "DESCRIPTION": "Glowing, fluid-like plasma with rotational symmetry and smooth animated distortions.",
	"CATEGORIES": [
		"Animated",
      "Complex",
      "Efficient",
