/*{
	"CREDIT": "by mojovideotech, based on https://glslsandbox.com/e#47584.1.",
	"CATEGORIES" : [
		"Animated", "Complex", "Inefficient", "3D", "NonCommercial"
  ],
  "DESCRIPTION": "Animated particle network with dynamic connections, movement variation, and optional color cycling.",
  "INPUTS" : [
	{
     	"NAME" :		"seed1",
     	"TYPE" : 		"float",
