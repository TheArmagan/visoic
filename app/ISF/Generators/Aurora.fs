/*
	{
	"DESCRIPTION": "Glowing purple vortex with a dark central void surrounded by swirling plasma-like energy.",
	"CATEGORIES": 
		[
		"Complex", "Efficient", "Space", "Animated", "NonCommercial", "Radial"
		],
	"ISFVSN": "2",
