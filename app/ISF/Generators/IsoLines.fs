/*{
  "CREDIT": "By mojovideotech, based on shadertoy.com/view/XdlyzS by FabriceNeyret2.",
  "DESCRIPTION": "Dynamic, multicolored contour lines with adjustable noise scale, edge sharpness, and visual styles.",
  "CATEGORIES" : [
    "Animated",
    "Efficient",
    "Complex",
