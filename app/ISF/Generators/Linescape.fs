/*
{
  ...
  "CREDIT": "By Imimot, based on shadertoy.com/view/4dfSDj.",
  "DESCRIPTION": "Monochromatic retro-style terrain lines with adjustable horizontal offset and movement speed.",
  "ISFVSN" : "2",
  "INPUTS" : [
    {
      "NAME" : "Offset_X",
