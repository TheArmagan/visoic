/*{
	...
	"DESCRIPTION": "3D volumetric particle field with swirling distortions and iterative noise-based motion.",
	"CATEGORIES": [
		"Complex",
		"Animated",
		"Efficient",
...
vec2 DE(vec3 pos) {
	...
	pos.z = pos.z + 0.3 * dist1 * sin(pos.y* 10.);
	pos.y = pos.y + dist2 * sin(pos.y *10.);
...
vec3 raycast() {
	...
	vec3 camera = vec3( offset_cam, 0., TIME * speed );
