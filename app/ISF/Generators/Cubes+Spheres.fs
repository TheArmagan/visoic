/*{
	"CREDIT": "by mojovideotech, automatically converted from http://glslsandbox.com/e#897.0.",
  "CATEGORIES": [
    "3D", "Complex", "Animated", "Efficient", "Raymarching", "NonCommercial"
  ],
  "DESCRIPTION": "Reflective rounded tiles arranged in a dynamic three-dimensional grid with a wave-like pattern.",
  "INPUTS": [
    {
      "MAX": [
        1,
