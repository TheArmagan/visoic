/*{
	"DESCRIPTION": "Smoothly scrolls texture using horizontal and vertical hold settings with persistent position tracking.",
	"CREDIT": "by zoidberg",
	"ISFVSN": "2",
	"CATEGORIES": [
		"Reflection", "Animated"
...
void main()
{
  ...
  if (PASSINDEX == 0) {
    ...
    srcPixel.xy = (flashEvent) ? vec2(0.0) : (srcPixel.xy - vec2(hHold / 1000.0, vHold / 1000.0));
