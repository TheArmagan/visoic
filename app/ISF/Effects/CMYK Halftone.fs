/*{
	"DESCRIPTION": "Generates a halftone pattern by simulating overlapping CMYK grids. Can use a simple method or a more complex 'lookaround' method for higher quality.",
    "CATEGORIES": [
        "Texture", "Static"
    ],
    "CREDIT": "by zoidberg",
