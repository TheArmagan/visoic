/*{
    "CATEGORIES": [
		...
		"DESCRIPTION": "Calculates edge boundaries and determines whether pixels fall inside or outside, affecting the color blending based on horizontal and vertical positioning and bleed settings.", 
    "CREDIT": "VIDVOX",
    "INPUTS": [
        {
            "NAME": "inputImage",
