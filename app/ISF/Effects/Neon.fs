/*{
	"DESCRIPTION": "",
	"CREDIT": "by VIDVOX adapted from https://github.com/neilmendoza/ofxPostProcessing/blob/master/src/GodRaysPass.cpp",
	"ISFVSN": "2",
	"DESCRIPTION": "Combines edge detection and radial light streaks with adjustable intensity, decay, and neon color tint.",
	"CATEGORIES": [
		"Texture", "Static"
	],
	"INPUTS": [
