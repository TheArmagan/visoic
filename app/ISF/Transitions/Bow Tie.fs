/*{
  ...
  "CREDIT": "Automatically converted from https://www.github.com/gl-transitions/gl-transitions",
  "DESCRIPTION": "Triangular wipe with the option for horizontal or vertical progression.",
  "ISFVSN": "2",
  "INPUTS": [
    {
      "NAME": "startImage",
