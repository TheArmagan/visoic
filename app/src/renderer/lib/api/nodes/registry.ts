...
nodeRegistry.register({
  type: 'audio:bass',
  label: 'Bass',
  description: 'Extract bass frequencies (60-250Hz)',
  category: 'audio',
  icon: '🔊',
  tags: ['audio', 'bass', 'frequency', 'low'],
  inputs: [
    { type: 'input', id: 'audio', label: 'Audio', dataType: 'audio', required: true },
  ...
  createDefaultData: (): AudioNodeData => ({
    ...
    inputValues: { audio: null, smoothing: 0.5 },
    outputValues: { value: 0 },
  }),
});
...
nodeRegistry.register({
  type: 'audio:mid',
  label: 'Mid',
  description: 'Extract mid frequencies (500Hz-2kHz)',
  category: 'audio',
  icon: '🔉',
  tags: ['audio', 'mid', 'frequency', 'middle'],
  inputs: [
    { type: 'input', id: 'audio', label: 'Audio', dataType: 'audio', required: true },
    { type: 'input', id: 'smoothing', label: 'Smoothing', dataType: 'number', defaultValue: 0.5 },
  ],
...
nodeRegistry.register({
  type: 'audio:treble',
  label: 'Treble',
  description: 'Extract treble frequencies (4-20kHz)',
  category: 'audio',
  icon: '🔈',
  tags: ['audio', 'treble', 'frequency', 'high', 'brilliance'],
  inputs: [
    { type: 'input', id: 'audio', label: 'Audio', dataType: 'audio', required: true },
    { type: 'input', id: 'smoothing', label: 'Smoothing', dataType: 'number', defaultValue: 0.5 },
  ],
